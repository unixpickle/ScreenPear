...
#import "UBTransportUDPServer.h"

@interface UBTransportServer (Private)
...
@implementation UBTransportUDPServer
...
- (void)acceptThreadMethod:(NSNumber *)fd {
    while (YES) {
        @autoreleasepool {
            ...
            UBTransport * tp = [[UBTCPTransport alloc] initWithFileDescriptor:aConn];
